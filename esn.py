...
Readout training with Moore-Penrose Matrix Inverse.
...
class ESN():
    ...
    def __init__(self, n_inputs, n_outputs, n_reservoir=200,
                 ...
                 input_scaling=None,
                 noise=0.001, input_shift=None,teacher_forcing=None, feedback_scaling=None,
...
#            self.n_reservoir, self.n_inputs) * 2 - 1
        ...
        # [nk] following Jaeger's paper:
        self.W_in = np.random.uniform(low = -0.1, high = 0.1, size = (self.n_reservoir, self.n_inputs))
...
#        transient = min(int(inputs.shape[1] / 10), 100)
        ...
        try:
            ...
            print(str(teachers_scaled[transient:, :]))
